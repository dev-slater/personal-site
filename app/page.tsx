    ...
    <div className="flex flex-col min-h-screen font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-1 flex-col items-start justify-center px-8 py-32 mx-auto w-full max-w-5xl">
        <div className="max-w-2xl">
          <h1 className="mb-6 text-5xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white [text-wrap:balance] sm:text-6xl">
            Matthew Slater
          </h1>
          <p className="mb-12 text-lg text-gray-500 dark:text-gray-400 leading-relaxed">
            GTM at{" "}
            <a
              href="https://tempo.xyz"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-900 dark:text-white transition-opacity duration-200 hover:opacity-70"
            >
              Tempo
            </a>
            .
